...
{
  int  IloscKodow = 10;
  int  Rozmiar = IloscKodow * 2 * sizeof('�'); /* W C++ sizeof('?') zwraca wartosc 1, w wyniku czego alokowane jest zbyt malo pamieci przez co program nie dziala poprawnie. Trzeba zwiekszyc ilosc alokowanej pamieci mnozac wynik lub 
                                                stosujac wewnatrz sizeof literal lancuchowy zamiast znakowego - sizeof(" "). Test przeprowadzony na diablo*/
